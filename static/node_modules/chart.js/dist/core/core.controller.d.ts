...
declare class Chart {
    static defaults: import("chart.js/dist/core/core.defaults.js").Defaults;
    static instances: {};
    static overrides: any;
    static registry: import("chart.js/dist/core/core.registry.js").Registry;
    ...
    chartArea: any;
    _active: any[];
    _lastEvent: import("chart.js/dist/types").ChartEvent;
    _listeners: {};
    ...
    set options(arg: any);
    get options(): any;
    get registry(): import("chart.js/dist/core/core.registry.js").Registry;
    /**
       * @private
       */
    private _initialize;
     ...
     * @param {import('chart.js/dist/core/core.plugins.js').filterCallback} [filter] - Filtering function for limiting which plugins are notified
       * @returns {boolean} false if any of the plugins return false, else returns true.
       */
    notifyPlugins(hook: string, args?: any, filter?: import('chart.js/dist/core/core.plugins.js').filterCallback): boolean;
    /**
     ...
     * @param {import('chart.js/dist/types').ActiveElement[]} lastActive - Previously active elements
     * @param {boolean} inChartArea - Is the envent inside chartArea
     * @param {boolean} useFinalPosition - Should the evaluation be done with current or final (after animation) element positions
     * @returns {import('chart.js/dist/types').ActiveElement[]} - The active elements
     * @pravate
     */
    _getActiveElements(e: ChartEvent, lastActive: import('chart.js/dist/types').ActiveElement[], inChartArea: boolean, useFinalPosition: boolean): import('chart.js/dist/types').ActiveElement[];
}
import Config from "chart.js/dist/core/core.config.js";
import PluginService from "chart.js/dist/core/core.plugins.js";
