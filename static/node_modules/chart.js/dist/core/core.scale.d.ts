export default class Scale extends Element<import("chart.js/dist/types/basic.js").AnyObject, import("chart.js/dist/types/basic.js").AnyObject> {
    constructor(cfg: any);
    /** @type {string} */
    id: string;
    /** @type {string} */
    ...
    getLabels(): string[];
    /**
     * @return {import('chart.js').LabelItem[]}
     */
    getLabelItems(chartArea?: any): import('chart.js').LabelItem[];
    beforeLayout(): void;
    beforeUpdate(): void;
    /**
