 ...
 * @param {import('preact/compat/src/internal').VNode} vnode VNode tree to render
 * @param {import('preact/compat/src/internal').PreactElement} parent DOM node to render vnode tree into
 * @param {() => void} [callback] Optional callback that will be called after rendering
 * @returns {import('preact/compat/src/internal').Component | null} The root component reference or null
 */
